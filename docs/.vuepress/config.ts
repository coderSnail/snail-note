...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "蜗牛笔记",
      description: 'java后端技术知识库,专注java后端学习与总结。Java,Spring全家桶,数据库,python,git等技术文章。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'coderSnail/snail-note', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'CoderSnail', // 必需
      link: 'https://github.com/coderSnail', // 可选的
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'CoderSnail | <a href="https://github.com/coderSnail/snail-note/blob/main/LICENSE" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
  ...
  head: [
    ...
    [
      ...
      {
        name: 'keywords',
        content: '后端笔记,个人技术知识库,后端,后端开发,后端框架,后端面试题,技术文档,学习,面试,Java,Mysql,Redis,python,git,github,markdown',
      },
    ],
